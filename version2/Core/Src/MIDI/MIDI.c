...
void Send_MIDINoteOn_1(uint8_t control){ //Enviar código MIDI NoteOn de la fila 1 correspondiente a cada nota en funcion del codigo de control
	...
	{
	case 0:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_C3, 3, 100);
		break;
	case 1:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_Csos3, 3, 100);
		break;
	case 2:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_D3, 3, 100);
		break;
	case 3:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_Dsos3, 3, 100);
		break;
	case 4:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_E3, 3, 100);
		break;
	case 5:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_F3, 3, 100);
		break;
	case 6:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_Fsos3, 3, 100);
		break;

	case 7:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_G3, 3, 100);
		break;

	case 8:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_Gsos3, 3, 100);
		break;

	case 9:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_A3, 3, 100);
		break;

	case 10:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_Asos3, 3, 100);
		break;

	case 11:
		HAL_UART_Transmit(&huart2, (uint8_t*)&MIDI_B3, 3, 100);
		break;
	}
}
