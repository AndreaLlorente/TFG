...
//	uint8_t MIDI_C4[3] = {0x90, 0x3C, volumen};
	...
	if (control <= 12){
		uint8_t MIDI[3] = {0x90, 0x30 + control, volumen};
...
//	uint8_t MIDI_C4[3] = {0x90, 0x3C, 0x00};
	...
	if (control <= 12){
		uint8_t MIDI[3] = {0x90, 0x30 + control, 0x00};
		HAL_UART_Transmit(&huart2, MIDI, 3, 100);
	}
}
...
//	uint8_t MIDI_C5[3] = {0x90, 0x48, volumen};
	...
	if (control <= 12){
		uint8_t MIDI[3] = {0x90, 0x3C + control, volumen};
		HAL_UART_Transmit(&huart2, MIDI, 3, 100);
	}
}
...
//	uint8_t MIDI_C5[3] = {0x90, 0x48, 0x00};
	...
	if (control <= 12){
		uint8_t MIDI[3] = {0x90, 0x3C + control, 0x00};
		HAL_UART_Transmit(&huart2, MIDI, 3, 100);
	}
}
